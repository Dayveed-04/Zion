    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
      <section className="max-w-4xl mx-auto px-4 py-12 max-md:py-8 text-center mb-16 max-md:mb-10">
        ...
        <p className="text-gray-600 mb-2 max-md:text-sm">
          We would love to welcome you to our church family. Here's everything
      ...
      <section className="max-w-4xl mx-auto px-4 pb-32 mb-32 max-md:pb-16 max-md:mb-16">
        <div className="bg-red-100 p-6 max-md:p-4 rounded-lg shadow-md">
          ...
          <div className="flex gap-3 mt-5 pt-4 border-t border-red-200">
            <a
              href="https://www.facebook.com/share/18Z1iJQRqk/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#DB241E] hover:text-red-800 transition-colors duration-200"
            >
              <FaFacebook size={20} />
            </a>

            <a
              href="https://www.instagram.com/zionmins?igsh=MTJ5ZXlpeTI1ZmZodQ=="
              target="_blank"
              rel="noopener noreferrer"
              className="text-[#DB241E] hover:text-red-800 transition-colors duration-200"
            >
